...
- Como getBluePrint() ya existe solo se crea getBlueprintsByAuthor() en BlueprintsPersistance.

![](img/media/parte2_1.png)

- Luego se implementa lo requerido para cada método en InMememoryBlueprintPersistence.
